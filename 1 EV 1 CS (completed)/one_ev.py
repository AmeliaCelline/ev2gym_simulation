...
# IN THIS SIMULATION, the traditional power generated by the grid uses the simulator’s generate_power_setpoint function in utils.py
# power balance = traditional power from grid (electricity generated not from RE) + power generated from PV - power consumed by load - power consumed by EV
...
axs[0].plot(df.index, df['power_setpoint'], label='Traditional Power Generator', color='green', linewidth = 3)
